            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <div className="hidden md:flex items-center space-x-3">
                  <Button variant="outline" className="h-9" onClick={openSignInDialog}>
                    Sign in
                  </Button>
                  <Button 
                    className="h-9 bg-homeez-600 hover:bg-homeez-700" 
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-md">
              ...
              {!user && (
                <div className="flex flex-col space-y-2 mt-4 px-3">
                  <Button variant="outline" className="w-full" onClick={openSignInDialog}>
                    Sign in
                  </Button>
                  <Button className="w-full bg-homeez-600 hover:bg-homeez-700" onClick={openSignUpDialog}>
                    Sign up
                  </Button>
                </div>
              )}
